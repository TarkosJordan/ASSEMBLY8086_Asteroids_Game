...
.data  
   ...
   saude_game db 00h,00h,00h,0Ah,0Ah,0Ah,00h,00h,00h,00h
    ...
    pos_yo_navegame db 120    ; pos y nave dentro do jogar (variavel atualizada pelas teclas up e down)
...
endp
    ...
    trata_teclado_game PROC
        ...
        arrow_up_game: 
            ...
            mov AL, pos_yo_navegame
            cmp AL, 20
            ; se for maior ou igual ao limite superior da tela movimenta
            jg movimenta_nave_cima
            je movimenta_nave_cima
            jmp nokey_game

            ; movimenta nave para cima
            movimenta_nave_cima:
                sub AL, 10
                mov pos_yo_navegame, AL
                jmp nokey_game

        arrow_down_game:
            ; testa o limite de tamanho da tela
            mov AL, pos_yo_navegame
            cmp AL, 120 ; nao consigo definir o limite inferior da tela...
            ; se for menor ou igual ao limite inferior da tela movimenta
            jl movimenta_nave_baixo
            je movimenta_nave_baixo
            jmp nokey_game

            ; movimenta nave para baixo
            movimenta_nave_baixo:
                add AL, 10
                mov pos_yo_navegame, AL
                jmp nokey_game
